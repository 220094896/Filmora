  ...
  try {
    ...
    const genres = await Genre.insertMany([
      ...
      },
      {
        name: "Drama",
        description:
          "Story-driven movies focused on characters and emotional experiences.",
      },
      {
        name: "Fantasy",
      ...
      },
      {
        ...
        description:
          "Movies involving science, technology and futuristic concepts.",
      },
      {
        name: "Thriller",
    ...
    const movies = await Movie.insertMany([
...

      {
        ...
        rentalPrice: 35,
        image:
          "https://image.tmdb.org/t/p/w500/rNzQyW4f8B8cQeg7Dgj3nX2v7mD.jpg",
        totalCopies: 5,
        availableCopies: 5,
      },
...

      {
        ...
        rentalPrice: 50,
        image:
          "https://image.tmdb.org/t/p/w500/6oom5QYQ2yQTMJIbnvbkblH8Q7A.jpg",
        totalCopies: 5,
        availableCopies: 5,
      },
    ]);
    ...
    const sarah = users.find((user) => user.email === "sarah@example.com");

    const batman = movies.find((movie) => movie.title === "The Batman");
    ...
    await Movie.findByIdAndUpdate(batman._id, {
      $inc: { availableCopies: -1 },
    });

    await Movie.findByIdAndUpdate(inception._id, {
      $inc: { availableCopies: -1 },
    });
